...
def create_expertises():
    ...
    returned_2={
                    "to_parent_collection_in_institution":
                        ...
                        [
                            {
                                "institution_acronym":"BE-NHM1",
                                "institution_name":"Royal Belgian Institute for Natural Sciences", 
                                "institution_url": "https:\\naturalsciences.be",
                                "collection_acronym":"BE-NHM1\Anthropology",
                                "collection_name": "Anthropology",
                                "collection_url": "http://collections.naturalsciences.be/cpb/nh-collections/countries/belgium#c0=all&b_start=0"
                            }
                       ,
                            {
                                "institution_acronym":"BE-NHM1",
                                "institution_name":"Royal Belgian Institute for Natural Sciences" ,
                                "institution_url": "https:\\naturalsciences.be",
                                "collection_acronym":"BE-NHM1\Zoology Vertebrates",
                                "collection_name": "Vertebrates",
                                "collection_url": "http://collections.naturalsciences.be/cpb/nh-collections/countries/belgium#c0=all&b_start=0"
                            }
                        ]
                    ,
                    "areas_of_expertise": ["Anthropology", "Collection Management", "Imaging"],
                    "country_en":"Belgium",
                    "country_iso3166":"be",
                    "seniority":"20 years",
    ...
    returned_2={
                    "to_parent_collection_in_institution":                    
                        [
                            {
                                "institution_acronym":"BE-NHM3",
                                "institution_name":"Musée National d'Histoire Naturelle", 
                                "institution_url": "https://www.mnhn.fr/"
                    ...
                    "dedication":"Full time",
                     "person":
                        {"name": "Régine Vignes-Lebbes",
                         "email": "regine.vignes_lebbe@sorbonne-universite.fr",
    ...
    returned_2={
                    "to_parent_collection_in_institution":
                       ...
                       ,
                            {
                                "institution_acronym":"BE-NHM2",
                                "institution_name":"Royal Museum for Central Africa" ,
                                "institution_url": "https:\\africamuseum.be",
                                "collection_acronym":"BE-NHM2\Zoology Vertebrates",
                                "collection_name": "Vertbrates",
                                "collection_url": "http://darwinweb.africamuseum.be/search_specimens"
                            }
                        ]
                    ,
                    "areas_of_expertise": ["IT developing"],
                    "country_en":"Belgium",
                    "country_iso3166":"be",
                    "seniority":"15 years",
                    "dedication":"Full time",
                     "person":
                        {"name": "Franck Theeten",
                         "email": "franck.theeten@naturalsciences.be",
                         "person_description":"IT Developer",
                         "phone":"+32 2 627 56 24",
                         "type":"researchers",
                         "title":"Msc"},
                     "taxonomic_fields":["Vertebrates"] ,
                     "person_identifier":{
                            "identifier_protocol":"ORCID",
                            "identifier_value":"0000-0002-0626-538X"
                        }
                 }
    es.index(index=INDEX_NAME_EXPERTISES, doc_type= "_doc",id="0000-0002-0626-538X", body=returned_2)
    returned_2={
                    "to_parent_collection_in_institution":
                    ...
                    ,
                    "areas_of_expertise": ["Mineralogy", "Loose sediments"],
                    "country_en":"Belgium",
                    "country_iso3166":"be",
                    "seniority":"15 years",
                    "dedication":"Full time",
                     "person":
                        {"name": "Pascale Lahogue",
                         "email": "pascale.lahogue@africamuseum.be",
                         "person_description":"researcher",
                         "phone":"+32 2 627 56 24",
                         "type":"researcher",
                         "title":"Dr"},
                     ...
                     "person_identifier":{
                            "identifier_protocol":"ORCID",
                            "identifier_value":"0000-0003-3993-6458"
                        }
                 }
    es.index(index=INDEX_NAME_EXPERTISES, doc_type= "_doc",id="0000-0003-3993-6458", body=returned_2)
    ...
    returned_2={
                    "to_parent_collection_in_institution":
                        ...
                        [
                            ...
                            {
                                "institution_acronym":"BE-NHM4",
                                "institution_name":"Botanischer Garten und Botanisches Museum Berlin" ,
                                "institution_url": "https:\\bgbm.org",
                                "collection_acronym":"BE-NHM4\Botany",
                                "collection_name": "Botany",
                                "collection_url": "http://biocase.de"
                            }
                        ]
                    ,
                    "areas_of_expertise": ["Botany", "Biodiversity Informatics"],
                    "country_en":"Germany",
                    "country_iso3166":"de",
                     "seniority":"15 years",
                     "dedication":"Full time",
                     "person":
                        {"name": "Andreas Kohlbecker",
                         ...
                         "person_description":"Research interests\r\nBiodiversity Informatics\r\nArchitecture of distributed biodiversity information facilities\r\nGeospatial information systems in biodiversity informatics",
                     ...
                     "person_identifier":{
                            "identifier_protocol":"ORCID",
                            "identifier_value":"0000-0003-1046-8750"
                        }
                 }
    es.index(index=INDEX_NAME_EXPERTISES, doc_type= "_doc",id="0000-0003-1046-8750", body=returned_2)
...
def coll_generator(iter_total=15):
    i=0
    for main_coll, subs in taxo_struct.items(): 
        print(main_coll)
...
def create_coll(museum, museum_name, coll, parent_coll=None):
    ...
    returned_2["collection_description"]=lorem_ipsum("Description of collection "+coll+ " for museum "+museum_name+ " ",iCols)
    ...
    staff1["staff_expertise_description"]="Agronomy and taxonomy"
    ...
    staff2["staff_expertise_description"]="Agronomy and taxonomy"
    ...
    for categ in tax_category:
        ...
        #cat["sum_all_collections"]={
        #    "taxonomic_category_confidence_pc":random.randrange(1,100),
        #    "taxonomic_category_detail":lorem_ipsum_short("taxonomic category detail all "+categ, iCols ),
        #    "taxonomic_category_mids_0_pc":cert0,
        #    "taxonomic_category_mids_1_pc":cert1,
        #    "taxonomic_category_mids_2_pc":cert2,
        #    "taxonomic_category_mids_3_pc":cert3,
        #}
        ...
        for val in area_vals:
            ...
            areas["area_name"]=val
            areas["area_detail"]=lorem_ipsum_short("taxonomic category detail area "+val, iCols )
    ...
    returned_2["size_and_digitisation_fields_sum_all"]=size
