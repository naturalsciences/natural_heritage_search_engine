...
namespace Naturalheritage\OaipmhBundle\Controller;
...
use Naoned\OaiPmhServerBundle\Controller\MainController ;
...
private $availableVerbs = array(
    ...
    public function indexAction(Request $request)
    {
        try {
            ...
            return $this->error($code, $e->getMessage(). " " .$e->getfile()." ".$e->getLine());
        }
    }
    ...
    private function error($code, $message = '')
    {
        ...
        return $this->render(
            'NaturalheritageOaipmhBundle::error.xml.twig',
            $viewParams = array(
                'code'        => $code,
                'message'     => $message,
    ...
    private function identifyVerb(Request $request)
    {
        ...
        return $this->render(
            'NaturalheritageOaipmhBundle::identify.xml.twig',
            array(
    ...
    private function getRecordVerb(Request $request)
    {
        ...
        return $this->render(
            'NaturalheritageOaipmhBundle::getRecord.xml.twig',
            array(
                'record'         => $record,
                'queryParams'    => $this->queryParams,
    ...
    {
        return $this->render(
            'NaturalheritageOaipmhBundle::listRecords.xml.twig',
    ...
    {
        return $this->render(
            'NaturalheritageOaipmhBundle::listIdentifiers.xml.twig',
            $this->listCommon($request)
        );
    }
    ...
    private function listMetadataFormatsVerb(Request $request)
    {
        ...
        return $this->render(
            'NaturalheritageOaipmhBundle::listMetadataFormats.xml.twig',
            array(
    ...
    private function listSetsVerb(Request $request)
    {
        ...
        return $this->render(
            'NaturalheritageOaipmhBundle::listSets.xml.twig',
            array(
